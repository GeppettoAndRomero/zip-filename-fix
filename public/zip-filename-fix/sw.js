...
const PRECACHE_URLS = [
  '/zip-filename-fix/',
  '/zip-filename-fix/manifest.json',
  '/zip-filename-fix/icon-192.png',
  '/zip-filename-fix/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/zip-filename-fix/manifest.json';
}
