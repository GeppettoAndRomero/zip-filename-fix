...
export const ui = {
  en: {
    ...
    uploadSubtitle: 'Choose a .zip with garbled filenames.',
    dropClick: 'Click to choose files',
    dropOr: 'or drop files anywhere on the page',
    dropSupported: 'ZIP archives',
    settingsButton: 'Settings',
    fixing: 'Fixing…', fixedMsg: 'Fixed {fixed} of {total} names — downloading the fixed archive.', nothingMsg: 'Names already look fine ({total} entries) — nothing to fix.',
    ...
    dzDropSub: 'Drop a .zip to fix its filenames',
  ...
  ja: {
    ...
    uploadSubtitle: '文字化けした .zip を選んでください。',
    dropClick: 'クリックして選択',
    dropOr: 'またはページ上にドロップ',
    dropSupported: 'ZIP アーカイブ',
    settingsButton: '設定',
    fixing: '修正中…', fixedMsg: '{total} 件中 {fixed} 件の名前を修正しました — 修正済みアーカイブをダウンロードします。', nothingMsg: '名前はすでに正常です（{total} 件）— 修正は不要でした。',
  ...
  zh: {
    // ConversionManager
    uploadHeading: '选择文件',
    uploadSubtitle: '选择文件名乱码的 .zip。',
    dropClick: '点击选择文件',
    dropOr: '或把文件拖到页面任意位置',
    dropSupported: 'ZIP 压缩包',
    settingsButton: '设置',
    fixing: '正在修复…', fixedMsg: '已修复 {total} 个中的 {fixed} 个名称 — 正在下载修复后的压缩包。', nothingMsg: '名称看起来正常（{total} 项）— 无需修复。',
  ...
  de: {
    ...
    uploadSubtitle: 'Wähle eine .zip mit kaputten Dateinamen.',
    dropClick: 'Zum Auswählen klicken',
    dropOr: 'oder Dateien irgendwo auf die Seite ziehen',
    dropSupported: 'ZIP-Archive',
    settingsButton: 'Einstellungen',
    fixing: 'Wird repariert…', fixedMsg: '{fixed} von {total} Namen repariert — das reparierte Archiv wird geladen.', nothingMsg: 'Die Namen sehen schon korrekt aus ({total} Einträge) — nichts zu reparieren.',
    ...
    dzDropSub: 'Lege eine .zip ab, um Dateinamen zu reparieren',
  ...
  es: {
    ...
    uploadSubtitle: 'Elige un .zip con nombres ilegibles.',
    ...
    fixing: 'Corrigiendo…', fixedMsg: 'Se corrigieron {fixed} de {total} nombres — descargando el archivo corregido.', nothingMsg: 'Los nombres ya se ven bien ({total} elementos) — no hay nada que corregir.',
    ...
    dzDropSub: 'Suelta un .zip para corregir los nombres',
